        ...
        <main className="max-w-6xl mx-auto p-4 grid gap-6">
          ...
          <SectionCard icon={GraduationCap} title="Module Quizzes">
            <div className="grid md:grid-cols-2 gap-6">
              ...
              />
              <ModuleQuiz
                title="PA: Wood-destroying"
                bank={content.categories?.wood_destroying || []}
                level={level}
              />
              <ModuleQuiz
                title="PA: Fumigation"
                bank={content.categories?.fumigation || []}
                level={level}
              />
            </div>
          </SectionCard>
          ...
          <SectionCard
            icon={ListChecks}
            title="Laws & Regulations — National"
          >
            <LinkList items={content.links?.national || []} />
          </SectionCard>
          <SectionCard
            icon={ListChecks}
            title="Laws & Regulations — Pennsylvania"
          >
