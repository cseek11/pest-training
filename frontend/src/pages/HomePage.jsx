    ...
    <>
      <div className="max-w-4xl items-center mx-auto text-center rounded-2xl mb-2 shadow-lg bg-[#404040]">
        <div className="flex justify-end">
          <button onClick={handleLogout} className="text-sm text-center text-white/80 hover:text-white underline">Logout</button>
        </div>
        <img src={veropestLogo} alt="VeroPest Logo" className="h-20 drop-shadow-lg mb-2 mx-auto" />
         <div className="max-w-4xl items-center mx-auto text-center rounded-1xl shadow-lg bg-[#f8fafc]">
