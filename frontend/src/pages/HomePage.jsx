  ...
  return (
    <div className="max-w-4xl mx-auto p-8 text-center rounded-2xl shadow-lg bg-[#F5F7FA]">
      <div className="flex flex-col items-center mb-8" >
       <div className="max-w-4xl mx-auto p-8 text-center rounded-2xl shadow-lg bg-[#000000]"> <img src={veropestLogo} alt="VeroPest Logo" className="h-16 mb-6 drop-shadow-lg" /></div>
